...
import 'package:flilipino_food_app/widget_designs/upload_widget.dart';
        ...
        children: [
          Padding(
            padding: const EdgeInsets.only(
              left: AppColors.spacing7,
              top: AppColors.spacing7,
            ),
            child: Text(
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.all(AppColors.spacing7),
                  child: AddImage(
                      width: widget.width,
                      height: widget.height,
                      onTap: () async {
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.only(left: AppColors.spacing4),
                  child: IconButton(
                    icon: Icon(
